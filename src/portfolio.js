...
const socialMediaLinks = {
  ...
  github: "https://github.com/floydmachine",
  linkedin: "https://www.linkedin.com/in/rijan-koju-00461a130/",
  gmail: "rijan.koju16@gmail.com",
  gitlab: "https://gitlab.com/rijankoju",
  ...
  data: [
    {
      ...
      skills: [
        "⚡ Java Programming: Mastery of core Java concepts and syntax, including object-oriented programming (OOP), exception handling, generics, and multithreading.",
        "⚡ Spring Framework: Proficiency in using the Spring framework for building enterprise Java applications, including Spring Core, Spring MVC, Spring Boot, and Spring Data. Knowledge of Hibernate ORM for database interaction, including entity mapping, transactions, and query optimization.",
        "⚡ Web Development with Angular: Experience in front-end web development using Angular framework for building dynamic and interactive web applications, including components, services, and HTTP client.",
        "⚡ Database Management: Expertise in database management systems, including Oracle, MySQL, and Microsoft SQL Server. This includes database design, querying using SQL, stored procedures, triggers, and indexes.",
        "⚡ RESTful Web Services: Experience in designing and implementing RESTful APIs using Spring MVC or Spring Boot for creating scalable and maintainable web services.",
      ],
      softwareSkills: [
        {
          skillName: "HTML5",
...
const contactPageData = {
  contactSection: {
    title: "Contact Me",
    profile_image_path: "rijankoju.jpg",
    description:
